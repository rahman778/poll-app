...
function CreatePoll() {
   ...
   return (
      <div className="min-h-[90vh] flex flex-col items-center justify-center py-8">
         ...
         <div className="w-full max-w-3xl bg-white dark:bg-gray-900 rounded-md px-4 py-5 sm:p-6 lg:p-8 mt-8">
            <form>
               <div>
                  <input
                     type="text"
               ...
               <div className="flex justify-end mt-6">
                  <button className="button primary-btn w-48">PUBLISH</button>
               </div>
            </form>
         </div>
      </div>
